...
class DeployConfig:
    ...
    update_llama_config: str = "dict(action_vocab_size=256,delta_vocab_size=8,sample_mode='text',theta=50000000,max_sequence_length=2048,scan_attention=True,scan_query_chunk_size=128,scan_key_chunk_size=128,scan_mlp=True,scan_mlp_chunk_size=1024,scan_layers=True)" 
...
def deploy(cfg: DeployConfig) -> None:
    try:
        ...
        if not maybe_restart_with_cpu(exc, "latent_pretraining.deploy"):
            raise
