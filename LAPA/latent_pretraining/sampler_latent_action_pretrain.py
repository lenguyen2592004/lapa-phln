...
from latent_pretraining.runtime_compat import ensure_enough_host_memory_for_7b, load_checkpoint_with_adaptive_buffer
...
class DeltaActionSampler:
    ...
    def _load_model(self):
        ensure_enough_host_memory_for_7b()
        ...
        with jax.default_device(jax.devices("cpu")[0]):
            _, self.params = load_checkpoint_with_adaptive_buffer(self.FLAGS.load_checkpoint)
